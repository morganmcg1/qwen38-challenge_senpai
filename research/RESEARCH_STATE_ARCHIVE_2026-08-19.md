# Research-state archive, superseded 2026-08-19T16:09Z

This is the previous `CURRENT_RESEARCH_STATE.md` in full, retained verbatim when that
file was pruned back to a living document at ledger item 179. Its stale headers
(`BASE_SHA = ccd1af6`, "Live slate — current, on base `ed4269c2`") are historical.
The per-experiment record of authority is `../senpai/campaign-ledger.md`; durable
measurements and closed questions live in `ESTABLISHED_FACTS.md`.
