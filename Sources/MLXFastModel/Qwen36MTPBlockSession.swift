...
public final class Qwen36MTPBlockSession {
    ...
    /// E165 ARM SWITCH. `MLX_E165_HEAD_PREFETCH=0` restores the shipped order,
    /// in which the head flush is built at the top of the round that uses it.
    /// Any other value, including unset, runs the prefetch. Both arms live in
